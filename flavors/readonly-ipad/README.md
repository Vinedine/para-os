...
1. Copy `base/skeleton/*` to the vault root, then copy `pipeline/*` next to it. For the vault's `CLAUDE.md`, start from this flavor's [`skeleton/CLAUDE.md.template`](skeleton/CLAUDE.md.template) instead of the base one.
